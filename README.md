...
- **Developer Experience**: Tab autocompletion, arrow history navigation, sound effects (Web Audio API synthesis), mobile virtual keyboard, and clickable command tags.
...
### 1. Clone & Install
```bash
git clone git@github.com:thesagarmahapatra/thesagarmahapatra.github.io.git
cd thesagarmahapatra.github.io
npm install
```
...
## 📄 License
MIT © [Sagar Swaraj Mahapatra](https://github.com/thesagarmahapatra)
